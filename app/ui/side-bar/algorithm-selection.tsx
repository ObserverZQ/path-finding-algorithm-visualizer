...
import { TextInput, Checkbox, Label, Button, Drawer, DrawerHeader, DrawerItems } from 'flowbite-react';
import {
  Accordion,
  AccordionContent,
  AccordionPanel,
        ...
        {algorithms.map((alg) => (
          <AccordionPanel key={alg}>
            ...
            <AccordionContent>
              ...
              <Button outline pill size="sm" className='mt-2 text-primary-500 border-primary-500'>Learn About {algorithm.name}</Button>
            </AccordionContent>
          </AccordionPanel>
        ))}
      </Accordion>
